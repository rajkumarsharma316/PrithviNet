...
export default function AlertsPage() {
  ...
  const canAction =
    user && ["SUPER_ADMIN", "REGIONAL_OFFICER"].includes(user.role);
  ...
  const SevIcon = ({ sev }) => {
    if (sev === "CRITICAL")
      return <AlertCircle size={18} color={SEV_COLORS.CRITICAL} />;
    if (sev === "WARNING")
      return <AlertTriangle size={18} color={SEV_COLORS.WARNING} />;
              ...
              <div style={{ flex: 1 }}>
                ...
                >
                  ...
                  >
                    <span
                      ...
                      style={{
                        background: `${SEV_COLORS[a.severity]}20`,
                        color: SEV_COLORS[a.severity],
                        border: `1px solid ${SEV_COLORS[a.severity]}40`,
                      }}
                    >
                      {a.severity}
                    </span>
                    <span
                      className="status-badge"
                      style={{
                        background: `${STAT_COLORS[a.status]}20`,
                        color: STAT_COLORS[a.status],
                        border: `1px solid ${STAT_COLORS[a.status]}40`,
                      }}
                    >
                      {a.status}
                    </span>
                ...
                {canAction && a.status !== "RESOLVED" && (
                  ...
                  >
                    ...
                    <button
                      className="action-btn small-btn resolve-btn"
