    ...
    <div>
      ...
      {result ? (
        <div
          ...
          style={{ padding: "32px", maxWidth: "500px", textAlign: "center" }}
        >
          ...
          {result.alertsGenerated > 0 ? (
            ...
            >
              ...
              <span style={{ fontWeight: 600 }}>
                {result.alertsGenerated} alert(s) generated!
              </span>
            </div>
          ) : (
          ...
          <div className="submit-fields-grid">
            {(fields[type] || []).map((f) => (
              <div key={f.key}>
                ...
                >
                  {f.label}{" "}
                  {f.unit && <span style={{ opacity: 0.6 }}>({f.unit})</span>}
                </label>
                <input
                  type="number"
                  step="any"
